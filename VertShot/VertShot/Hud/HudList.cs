...
namespace VertShot
{
    public class HudList
    {
        ...
        public HudList(Rectangle rect, List<string> stringList, int defaultValue = 0)
        {
            this.rect = rect;
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(Game1.buttonFont, stringList[value], new Vector2(rect.X + rect.Width / 2, rect.Y + rect.Height / 2) - Game1.buttonFont.MeasureString(stringList[value]) / 2, new Color(20, 120, 0, 160));
        }
